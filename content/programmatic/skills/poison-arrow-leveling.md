...
This page is a programmatic SEO draft for **Poison Arrow** in Path of Exile 2.

## Quick Summary

Poison Arrow is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Poison Arrow is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Poison Arrow.
