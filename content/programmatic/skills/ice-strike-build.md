...
This page is a programmatic SEO draft for **Ice Strike** in Path of Exile 2.

## Quick Summary

Ice Strike is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Ice Strike is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Ice Strike.
...
A Ice Strike build should focus on making the skill feel reliable before trying to maximize raw damage. Prioritize smooth clear, enough recovery, and support gems that improve consistency.
