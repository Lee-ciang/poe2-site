---
title: Earthshatter Best Support Gems
description: >-
  Learn how to use Earthshatter Best Support Gems in Path of Exile 2 with
  practical tips, setup advice, FAQs, and related skill guidance.
slug: /guides/skills/earthshatter-support-gems
...
# Earthshatter Best Support Gems

This page is a programmatic SEO draft for **Earthshatter** in Path of Exile 2.

## Quick Summary

Earthshatter is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Earthshatter is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Earthshatter.
...
The best support gems for Earthshatter should improve the way the skill naturally plays. Do not only chase tooltip damage. Prioritize supports that improve real combat performance.
