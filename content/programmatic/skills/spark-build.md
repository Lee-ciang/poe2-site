---
title: "Spark Build Guide"
description: "Learn how to use Spark Build in Path of Exile 2 with practical tips, setup advice, FAQs, and related skill guidance."
slug: "/guides/skills/spark-build"
sourceSkill: "spark"
...
This page is a programmatic SEO draft for **Spark** in Path of Exile 2.

## Quick Summary

Spark is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Spark is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Spark.
