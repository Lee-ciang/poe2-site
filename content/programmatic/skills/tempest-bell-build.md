---
title: Tempest Bell Build Guide
description: >-
  Learn how to use Tempest Bell Build in Path of Exile 2 with practical tips,
  setup advice, FAQs, and related skill guidance.
slug: /guides/skills/tempest-bell-build
...
# Tempest Bell Build Guide

This page is a programmatic SEO draft for **Tempest Bell** in Path of Exile 2.

## Quick Summary

Tempest Bell is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Tempest Bell is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Tempest Bell.
...
A Tempest Bell build should focus on making the skill feel reliable before trying to maximize raw damage. Prioritize smooth clear, enough recovery, and support gems that improve consistency.
