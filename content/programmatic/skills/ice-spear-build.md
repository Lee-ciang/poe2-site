---
title: Ice Spear Build Guide
description: >-
  Learn how to use Ice Spear Build in Path of Exile 2 with practical tips, setup
  advice, FAQs, and related skill guidance.
slug: /guides/skills/ice-spear-build
...
# Ice Spear Build Guide

This page is a programmatic SEO draft for **Ice Spear** in Path of Exile 2.

## Quick Summary

Ice Spear is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Ice Spear is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Ice Spear.
...
## Related Ice Spear Build Guide Guides
