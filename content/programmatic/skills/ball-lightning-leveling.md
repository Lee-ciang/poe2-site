---
title: Ball Lightning Leveling Guide
description: >-
  Learn how to use Ball Lightning Leveling in Path of Exile 2 with practical
  tips, setup advice, FAQs, and related skill guidance.
slug: /guides/skills/ball-lightning-leveling
...
# Ball Lightning Leveling Guide

This page is a programmatic SEO draft for **Ball Lightning** in Path of Exile 2.

## Quick Summary

Ball Lightning is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Ball Lightning is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Ball Lightning.
...
When leveling with Ball Lightning, focus on comfort first. A leveling setup should clear packs reliably, avoid awkward downtime, and work with gear that is easy to find during the campaign.
