...
This page is a programmatic SEO draft for **Ice Nova** in Path of Exile 2.

## Quick Summary

Ice Nova is a skill page candidate identified from the programmatic SEO expansion pipeline. This draft should be reviewed before publishing.
...
Explain when Ice Nova is worth using and what type of player it fits.
...
Reason generated: Programmatic long-tail expansion for Ice Nova.
...
When leveling with Ice Nova, focus on comfort first. A leveling setup should clear packs reliably, avoid awkward downtime, and work with gear that is easy to find during the campaign.
